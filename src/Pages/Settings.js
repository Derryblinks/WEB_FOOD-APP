...
//     //functions for the change in the themes
...
export default function Settings() {
    ...
    // Functions for changing preferred color, font size, and animation speed
    function changeColor(i) {
        let _settings = { ...settings };
